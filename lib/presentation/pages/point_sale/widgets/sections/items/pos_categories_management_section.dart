...
class _PosCategoriesManagementSectionState
    extends State<PosCategoriesManagementSection> with ListManagerRegisters {
  ...
  void _onTapItem(GenericListItem<Map<String, dynamic>> item) async {
    ...
    try {
      ...
      await showManagementForm(
        context: context,
        btnSaveTitle:  controller.btnUpdateText,
        btnCancelTitle:controller.btnCancelText,
        barrierDismissible: false,
        controller: controller,
        title: controller.titleMainUpdate,
            ...
            onPressed: () async {
              ...
              try {
                ...
                showManagementForm(
                  ...
                  context: context,
                  controller: controller,
                  btnSaveTitle: controller.btnSaveText,
                  btnCancelTitle:controller.btnCancelText,
                  title: controller.titleMainCreate,
      ...
      children: [
        SizedBox(
          ...
          child: EmptyData(
            ...
            title: controller.titleEmptyRegisters,
            descriptionText: controller.titleEmptyDescription,
            linkText: controller.titleEmptyLinkText,
          ),
        ),
      ],
    );
...
mixin ListManagerRegisters <T extends StatefulWidget> on State<T>{
